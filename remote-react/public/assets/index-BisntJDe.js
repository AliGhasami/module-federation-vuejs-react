...
function SimpleButton({ text = "دکمه React" }) {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "40px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Remote React" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleButton, {})
  ] });
}
